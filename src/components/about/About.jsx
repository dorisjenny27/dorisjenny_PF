 ...
 const About = () => {
  return (
    <section id='about'>
      <h5>Hello I'm</h5>
      <h1>Doris Okereke</h1>
      <h5 className='text-light position'>Software Engineer</h5>
        ...
        <div className='about__content'>
          <div className='about__cards'>
            <article className='about__card'>
              ...
              <h5>Experience</h5>
              <small>Over 4 Years Working</small>
            </article>
          ...
          <div className='text__container'>
            ...
            <span className='span'>
              {/* My name is <b>Okereke Vincent.</b>  */}
              As a <b>Software Engineer,</b> I design solutions from database to user interface.
              With expertise in C#, ASP.NET Core, and modern frontend frameworks, I transform complex challenges into elegant,
              user-centric applications. My passion for clean code and continuous learning drives me to deliver 
              cutting-edge solutions that exceed expectations. I don't settle for mediocrity – 
              I ignite innovation with every line of code. Ready to bring your vision to life? 
