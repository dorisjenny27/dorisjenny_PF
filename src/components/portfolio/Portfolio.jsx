...
const data = [

  {
    ...
    title: "Horizon is a modern banking platform for everyone, that connects multiple bank accounts, displays real-time transactions, and allows money transfers..",
    github: 'https://github.com/dorisjenny27/banking_App',
...

  {
    ...
    title: 'An online local community property sharing and renting platform that allows users connect and share houses/property.',
    github: 'https://github.com/dorisjenny27/Room8s-OnlinePropertyPlatform-Backend',
...

  {
    ...
    image: IMG3,
    /* technology: [ 'HTMl5', 'CSS3', 'JavaScript' ] ,*/
    title: `Digital Wallet system for an e-commerce store.`,
    github: 'https://github.com/dorisjenny27/WalletSystem_API',
